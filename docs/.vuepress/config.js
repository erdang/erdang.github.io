...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: "erdang/erdang.github.io", // 导航栏右侧生成Github链接
    ...
    author: {
      ...
      name: "Er Dang", // 必需
      href: "https://github.com/erdang", // 可选的
    },
    social: {
      // 社交图标，显示于博主信息栏和页脚栏
      ...
      icons: [
        {
          ...
          title: "发邮件",
          link: "mailto:924064382@qq.com",
        },
        {
          iconClass: "icon-github",
          title: "GitHub",
          link: "https://github.com/erdang",
        },
        {
          iconClass: "icon-erji",
          title: "听音乐",
    ...
    footer: {
      ...
      copyrightInfo: "Er Dang | MIT License", // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  plugins: [
